...
const Logo = ({
  ...
  return (
    <Link to="/" className={`flex items-center gap-2 hover:opacity-80 transition-opacity ${className ?? ''}`}>
      <svg width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-primary -mt-0.5">
      ...
      <h1 className="text-xl font-normal leading-none">Binge & Tonic</h1>
    </Link>
  );
};
